      ...
      <div className="max-w-7xl mx-auto px-4 py-6 sm:py-8">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <aside className="lg:w-72 flex-shrink-0">
            ...
            <div
              className={`bg-white rounded-xl shadow-md p-5 lg:sticky lg:top-24 transition-all ${
                ...
                <div>
                  ...
                  <RadioGroup value={selectedCategory} onValueChange={setSelectedCategory}>
                    {categories.map((category) => (
                      <div
                        key={category.value}
                        className="flex items-center space-x-2 mb-2 group hover:bg-gray-50 p-2 rounded-lg transition-colors"
                      >
                        <RadioGroupItem
          ...
          <main className="flex-1">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Select value={sortBy} onValueChange={setSortBy}>
                    <SelectTrigger
                      className="w-full sm:w-[200px] border-2"
            ...
            {isLoading ? (
              ...
              <div
                className={`${viewMode === 'grid' ? 'grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6' : 'space-y-4'} animate-fade-in`}
              >
