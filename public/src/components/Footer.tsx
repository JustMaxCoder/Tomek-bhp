      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
          ...
          <div className="col-span-1">
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-2 text-sm text-gray-900 hover:text-primary transition-colors group"
              >
              ...
              <a
                ...
                className="flex items-center gap-2 text-sm text-gray-900 hover:text-primary transition-colors group break-all"
              >
        ...
        <div className="md:hidden space-y-4">
          ...
          <div className="space-y-2 pb-4 border-b border-gray-100">
            ...
            <a
              href="mailto:kontakt@bhpperfect.pl"
              className="flex items-center gap-2 text-sm text-gray-900 break-all"
            >
          ...
          <div className="border-b border-gray-100 pb-4">
            ...
            {openSection === 'shop' && (
              <ul className="mt-3 space-y-2 pl-2 animate-slide-down">
                <li>
                  <Link href="/sklep" className="text-sm text-gray-600">
                    Wszystkie produkty
                  </Link>
                </li>
                <li>
                  <Link href="/sklep?category=odziez-robocza" className="text-sm text-gray-600">
                    Odzież robocza
                  </Link>
                </li>
                <li>
                  <Link href="/sklep?category=obuwie" className="text-sm text-gray-600">
                    Obuwie BHP
                  </Link>
                </li>
                <li>
                  <Link href="/sklep?category=rekawice" className="text-sm text-gray-600">
                    Rękawice
                  </Link>
                </li>
                <li>
                  <Link href="/sklep?category=uslugi" className="text-sm text-gray-600">
                    Usługi
                  </Link>
                </li>
              </ul>
          ...
          <div>
            ...
            >
              Obsługa klienta
              <ChevronDown
                className={`h-4 w-4 transition-transform ${openSection === 'service' ? 'rotate-180' : ''}`}
              />
            </button>
            {openSection === 'service' && (
              <ul className="mt-3 space-y-2 pl-2 animate-slide-down">
                <li>
                  <Link href="/kontakt" className="text-sm text-gray-600">
                    Kontakt
                  </Link>
                </li>
                <li>
                  <Link href="/sledzenie" className="text-sm text-gray-600">
                    Śledzenie zamówienia
                  </Link>
                </li>
                <li>
                  <Link href="/o-nas" className="text-sm text-gray-600">
                    O nas
                  </Link>
                </li>
                <li>
