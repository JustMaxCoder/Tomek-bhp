...
2. [Development Setup](#development-setup-з-neon-local-connect)
3. [Frontend](#1-frontend)
4. [Backend](#2-backend)
5. [База даних](#3-база-даних)
6. [Структура файлів](#4-структура-файлів-проекту)
7. [Deployment](#5-deployment-хостинг)
8. [Технології та рекомендації](#6-технології-та-рекомендації)
...
- **Localdevelopment**: Neon Local Connect Extension

---

## Development Setup з Neon Local Connect

### Вимоги
- Docker Desktop запущений
- VS Code 1.85.0+ (або Cursor/Windsurf)
- Neon аккаунт
- Node.js 18+
...
# Запустити setup скрипт (Windows)
...
### Налаштування Neon Local Connect Extension

1. **Встановити розширення** у VS Code Marketplace: "Neon Local Connect"
2. **Авторизуватися** у розширенні з Neon аккаунтом
3. **Вибрати**:
   - Organization: вашої організації
   - Project: вашого проекту
   - Branch: main або development гілка
4. **Скопіювати** CONNECTION STRING з розширення
5. **Оновити** `.env` файл:
   ```env
   DATABASE_URL=postgres://neon:npg@localhost:5432/bhp_perfect
   ```
...
# Запустити dev сервер (обидва - frontend та backend)
npm run dev
```

✅ Приложение буде доступне на `http://localhost:5000`

📖 **Детальна інструкція:** [NEON_LOCAL_SETUP.md](../NEON_LOCAL_SETUP.md)
