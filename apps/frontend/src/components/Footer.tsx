        ...
        <div className="hidden md:grid md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/sklep?category=uslugi" className="text-sm text-gray-600 hover:text-primary transition-colors">
                  Usługi
                </Link>
              </li>
            </ul>
          ...
          <div className="border-b border-gray-100 pb-4">
            ...
            {openSection === "shop" && (
              <ul className="mt-3 space-y-2 pl-2 animate-slide-down">
                ...
                <li><Link href="/sklep?category=uslugi" className="text-sm text-gray-600">Usługi</Link></li>
              </ul>
            )}
          </div>
